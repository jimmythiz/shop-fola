...
export const signUp = async (req, res) => {
  ...
  try {
    ...
    const verifyLink = `${process.env.FRONTEND_URL}/api/users/verify?token=${emailVerificationToken}`;
...
export const resetPassword = async (req, res) => {
  try {
    ...
    const resetLink = `${process.env.FRONTEND_URL}/api/users/reset-password/confirm?token=${rawToken}`;
    sendMail({
      email: user.email,
